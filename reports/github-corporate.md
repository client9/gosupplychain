...
|---------|-------------|---------|---------|
| [att/tegu](https://github.com/att/tegu) | Software Defined Networking (SDN) reservation manager. | Apache-2.0 | 2015-09-06 |
| [att/gopkgs](https://github.com/att/gopkgs) | A collection of Go packages | Apache-2.0 | 2015-09-06 |
...
| [bitly/file2http](https://github.com/bitly/file2http) | spray a line-oriented file at an HTTP endpoint | Apache-2.0 | 2015-09-21 |
...
| [cloudflare/gosession2](https://github.com/cloudflare/gosession2) | Code for GoSF: Go Session 2 | NewBSD | 2015-04-24 |
| [cloudflare/conf](https://github.com/cloudflare/conf) | Really, really simple key=val configuration file parser | NewBSD | 2015-09-08 |
| [cloudflare/ahocorasick](https://github.com/cloudflare/ahocorasick) | A Golang implementation of the Aho-Corasick string matching algorithm | NewBSD | 2015-10-10 |
| [cloudflare/go-stream](https://github.com/cloudflare/go-stream) |  | FreeBSD | 2015-10-12 |
...
| [coreos/etcdctl](https://github.com/coreos/etcdctl) | A simple command line client for etcd | Apache-2.0 | 2015-10-15 |
| [coreos/coretest](https://github.com/coreos/coretest) | Sanity tests for a minimal Linux | Apache-2.0 | 2015-06-25 |
| [coreos/go-workflow](https://github.com/coreos/go-workflow) |  | Apache-2.0 | 2015-10-15 |
| [coreos/third_party.go](https://github.com/coreos/third_party.go) | third_party.go - self contained GOPATH helper | Apache-2.0 | 2015-08-31 |
| [coreos/etcd-starter](https://github.com/coreos/etcd-starter) |  | Apache-2.0 | 2015-09-28 |
| [coreos/gzran](https://github.com/coreos/gzran) | gzip indexer for random access into compressed files | Apache-2.0 | 2015-08-26 |
| [coreos/etcd-manager](https://github.com/coreos/etcd-manager) | An etcd cluster management tool | Apache-2.0 | 2015-09-28 |
| [coreos/aci-discovery](https://github.com/coreos/aci-discovery) | App Container Image Discovery Server | Apache-2.0 | 2015-08-15 |
| [coreos/sdnotify-proxy](https://github.com/coreos/sdnotify-proxy) | Proxy the sd_notify messages between systemd and process in a different cgroup | Apache-2.0 | 2015-09-28 |
| [coreos/go-namespaces](https://github.com/coreos/go-namespaces) | DEPRECATED: Golang implementations of Linux Namespaces | Apache-2.0 | 2015-09-28 |
| [coreos/go-omaha](https://github.com/coreos/go-omaha) | omaha protocol for go | Apache-2.0 | 2015-10-08 |
| [coreos/devweb](https://github.com/coreos/devweb) |  | NewBSD | 2015-09-28 |
| [coreos/subgun](https://github.com/coreos/subgun) | Subscribe to a mailing list on mailgun via a web interface | Apache-2.0 | 2015-08-31 |
| [coreos/nsproxy](https://github.com/coreos/nsproxy) | Linux namespaces tcp proxy | Apache-2.0 | 2015-05-09 |
| [coreos/core-admin](https://github.com/coreos/core-admin) | Utility to interact with core-os.net administrative service API endpoints | Apache-2.0 | 2015-09-28 |
| [coreos/core-cache](https://github.com/coreos/core-cache) |  | Apache-2.0 | 2015-09-28 |
| [coreos/gocat](https://github.com/coreos/gocat) | Socket activated transparent SSL proxy written in Go | Apache-2.0 | 2015-09-28 |
| [coreos/go-webrtc-datachannel](https://github.com/coreos/go-webrtc-datachannel) |  | Apache-2.0 | 2015-10-05 |
| [coreos/motd-http](https://github.com/coreos/motd-http) | Fixture test server that displays /etc/motd | FreeBSD | 2015-09-28 |
| [coreos/go-gitreceive](https://github.com/coreos/go-gitreceive) | A gitreceive implementation in Go | Apache-2.0 | 2015-08-21 |
| [coreos/systemd-rest](https://github.com/coreos/systemd-rest) |  | Apache-2.0 | 2015-08-05 |
...
| [docker/dnsserver](https://github.com/docker/dnsserver) | A small DNS service for communicating A and SRV records. | Apache-2.0 | 2015-10-19 |
...
| [facebookgo/tool](https://github.com/facebookgo/tool) | Go library that wraps the go tool. | FreeBSD | 2015-09-21 |
| [facebookgo/subset](https://github.com/facebookgo/subset) | A library to check if a value is a subset of another. Useful for testing. | FreeBSD | 2015-09-29 |
| [facebookgo/stack](https://github.com/facebookgo/stack) | Package stack provides utilities to capture and pass around stack traces. | FreeBSD | 2015-09-30 |
| [facebookgo/runcmd](https://github.com/facebookgo/runcmd) | Package runcmd provides a convenience Run function for exec.Cmd which includes the original command along with the output and error streams. | FreeBSD | 2015-09-29 |
...
| [facebookgo/counting](https://github.com/facebookgo/counting) | Package counting provides wrappers to add counting to io.Reader and io.Writer. | FreeBSD | 2015-10-15 |
| [facebookgo/cmdctrl](https://github.com/facebookgo/cmdctrl) | Package cmdctrl provides very specific startup handling for a daemon process without any possibility for customization. | FreeBSD | 2015-09-29 |
| [facebookgo/structtag](https://github.com/facebookgo/structtag) | Package structtag provides parsing of the defacto struct tag style. | NewBSD | 2015-08-16 |
| [facebookgo/mysqltest](https://github.com/facebookgo/mysqltest) | Package mysqltest provides standalone instances of mysql suitable for use in tests. | FreeBSD | 2015-07-27 |
...
| Package | Description | License | Updated |
|---------|-------------|---------|---------|
| [fastly/go-utils](https://github.com/fastly/go-utils) | utils for go | MIT | 2015-10-18 |
| [fastly/secretd](https://github.com/fastly/secretd) | Secret storage server |  | 2015-09-07 |
| [fastly/jlog-go](https://github.com/fastly/jlog-go) | Go bindings for jlog | MIT | 2014-06-26 |
| [fastly/go-mtr](https://github.com/fastly/go-mtr) | go wrapped mtr --raw | MIT | 2015-10-06 |
...
| [google/ct-hackday-schwag](https://github.com/google/ct-hackday-schwag) | May 7th, 2014 Certificate Transparency Hack Day  | Apache-2.0 | 2015-05-26 |
| [google/self-hosted-rss-to-email](https://github.com/google/self-hosted-rss-to-email) |  | Apache-2.0 | 2015-03-26 |
...
| [hashicorp/atlas-upload-cli](https://github.com/hashicorp/atlas-upload-cli) | CLI to upload application code to Atlas. | MPL-2.0 | 2015-10-19 |
| [hashicorp/scada-client](https://github.com/hashicorp/scada-client) | Implements a Golang client to the HashiCorp SCADA system | MPL-2.0 | 2015-08-28 |
| [hashicorp/consul-replicate](https://github.com/hashicorp/consul-replicate) | Consul cross-DC KV replication daemon | MPL-2.0 | 2015-10-16 |
| [hashicorp/raft-mdb](https://github.com/hashicorp/raft-mdb) | LMDB backend for Raft | MPL-2.0 | 2015-09-12 |
| [hashicorp/logutils](https://github.com/hashicorp/logutils) | Utilities for slightly better logging in Go (Golang). | MPL-2.0 | 2015-10-18 |
| [hashicorp/consul-migrate](https://github.com/hashicorp/consul-migrate) | Consul server data migrator | MPL-2.0 | 2015-08-31 |
...
| [heroku/draincat](https://github.com/heroku/draincat) | Like netcat but for Heroku logs | MIT | 2015-08-21 |
| [heroku/sql-drain](https://github.com/heroku/sql-drain) | Drain Heroku app logs to a SQL database | MIT | 2015-08-17 |
| [heroku/logplex-cli](https://github.com/heroku/logplex-cli) | Logplex client written in Go |  | 2015-08-17 |
| [heroku/sproxy](https://github.com/heroku/sproxy) | Splunk Google Oauth 2.0 Proxy | Apache-2.0 | 2014-09-11 |
| [heroku/hsup](https://github.com/heroku/hsup) | Supervises processes that are configured in a Heroku-esque way. | FreeBSD | 2015-08-11 |
| [heroku/busl](https://github.com/heroku/busl) | a simple pubsub service that runs on Heroku | MIT | 2015-09-23 |
| [heroku/shh](https://github.com/heroku/shh) | Shh - Systems Heuristics Herald | GPL-3.0 | 2015-09-14 |
| [heroku/pgdiagnose](https://github.com/heroku/pgdiagnose) | server side part of `heroku pg:diagnose` | MIT | 2015-10-05 |
| [heroku/gtils](https://github.com/heroku/gtils) |  |  | 2015-01-27 |
| [heroku/instruments](https://github.com/heroku/instruments) | Collecting metrics over discrete time intervals | MIT | 2015-08-06 |
| [heroku/authenticater](https://github.com/heroku/authenticater) |  | Apache-2.0 | 2015-03-24 |
...
| [influxdb/hyperleveldb-go](https://github.com/influxdb/hyperleveldb-go) |  | MIT | 2015-04-27 |
...
| [sendgrid/go-gmime](https://github.com/sendgrid/go-gmime) |  | MIT | 2015-08-14 |
| [sendgrid/smtpapi-go](https://github.com/sendgrid/smtpapi-go) | Wrapper for SendGrid's X-SMTPAPI in Go |  | 2015-09-27 |
| [sendgrid/stopwatch](https://github.com/sendgrid/stopwatch) | Benchmark your Go code  with this utility for keeping track of timing information for different states. | NewBSD | 2015-08-31 |
| [sendgrid/martini](https://github.com/sendgrid/martini) |  | MIT | 2014-04-15 |
...
| Package | Description | License | Updated |
|---------|-------------|---------|---------|
| [sony/gobreaker](https://github.com/sony/gobreaker) | Circuit Breaker implemented in Go | MIT | 2015-10-15 |
| [sony/sonyflake](https://github.com/sony/sonyflake) | A distributed unique ID generator inspired by Twitter's Snowflake | MIT | 2015-10-14 |
...
| Package | Description | License | Updated |
|---------|-------------|---------|---------|
| [spotify/syslog-redirector](https://github.com/spotify/syslog-redirector) | Redirects stdin/stderr to syslog | Apache-2.0 | 2015-08-31 |
| [spotify/helios-go](https://github.com/spotify/helios-go) | Go client for Helios | Apache-2.0 | 2014-09-29 |
| [spotify/syslog-redirector-golang](https://github.com/spotify/syslog-redirector-golang) | A specific build and version of golang known to properly create static executables  | NewBSD | 2015-09-02 |
...
| Package | Description | License | Updated |
|---------|-------------|---------|---------|
| [vimeo/go-taglog](https://github.com/vimeo/go-taglog) | Based on, and compatible with, the Go standard log package, but also provides additional functionality and features such as tagging. | FreeBSD | 2015-08-31 |
| [vimeo/go-util](https://github.com/vimeo/go-util) | Small reusable Go functions. | FreeBSD | 2015-08-16 |
| [vimeo/go-hammer](https://github.com/vimeo/go-hammer) |  | MIT | 2015-08-09 |
| [vimeo/graphite-aggregation-backfiller](https://github.com/vimeo/graphite-aggregation-backfiller) |  | Apache-2.0 | 2015-04-08 |
| [vimeo/graphite-go](https://github.com/vimeo/graphite-go) |  |  | 2015-05-22 |
| [vimeo/whisper-to-influxdb](https://github.com/vimeo/whisper-to-influxdb) | migrate (import) graphite data from whisper to influxdb | Apache-2.0 | 2015-10-04 |
| [vimeo/carbon-tagger](https://github.com/vimeo/carbon-tagger) | native tag-based metrics for graphite/carbon | Apache-2.0 | 2015-10-03 |
| [vimeo/go-magic](https://github.com/vimeo/go-magic) | Go Bindings for libmagic and an idiomatic API for getting a file's MIME type. | FreeBSD | 2015-09-30 |
| [vimeo/go-iccjpeg](https://github.com/vimeo/go-iccjpeg) | A small utility package to extract ICC profiles from JPEGs. | FreeBSD | 2014-11-05 |
| [vimeo/go-imgparse](https://github.com/vimeo/go-imgparse) | A small go library to efficiently parse the resolution of various image format streams. | FreeBSD | 2015-05-23 |
| [vimeo/netstorage](https://github.com/vimeo/netstorage) | go client for the new Akamai Netstorage http api | Apache-2.0 | 2015-03-27 |
| [vimeo/smoketcp](https://github.com/vimeo/smoketcp) | Smokeping like tcp connectivity tester, reports to statsd. written in Golang | Apache-2.0 | 2015-09-11 |
